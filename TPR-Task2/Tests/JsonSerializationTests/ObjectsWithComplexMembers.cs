...
//             Employee person2 = new Employee(Guid.NewGuid(), "Katarzyna", "Kowalska", new DateTime(1967, 03, 13), "123456789", "kaska123@outlook.com", "female", new DateTime(2019, 9, 11));
//             Reader person1 = new Reader(Guid.NewGuid(), "Adam", "Nowak", new DateTime(1998, 05, 23), "111222333", "adam.nowak@gmail.com", "male", new DateTime(2019, 9, 11));
...
//             CopyOfBook cob2 = new CopyOfBook(Guid.NewGuid(), hobbit, new DateTime(2014, 12, 3, 0, 0, 0), 0.6);
//             Employee person2 = new Employee(Guid.NewGuid(), "Katarzyna", "Kowalska", new DateTime(1967, 03, 13), "123456789", "kaska123@outlook.com", "female", new DateTime(2019, 9, 11));
//             Reader person1 = new Reader(Guid.NewGuid(), "Adam", "Nowak", new DateTime(1998, 05, 23), "111222333", "adam.nowak@gmail.com", "female", new DateTime(2019, 9, 11));
//             List<CopyOfBook> booksForRent = new List<CopyOfBook> { cob1, cob2 };
//             Rent rent1 = new Rent(Guid.NewGuid(), person1, person2, booksForRent, new DateTime(2010, 1, 6, 0, 0, 0));
//
//             // Creating Return
...
//                 "agnieszka.kleczkowska@p.lodz.pl", "female", DateTime.Now);
//             Reader reader2 = new Reader(Guid.NewGuid(), "Adam", "Nowak", new DateTime(1998, 05, 23),
//                 "111222333", "adam.nowak@gmail.com", "female", new DateTime(2019, 9, 11));
//             Employee employee1 = new Employee(Guid.NewGuid(), "Katarzyna", "Kowalska", new DateTime(1967, 03, 13),
//                 "123456789", "kaska123@outlook.com", "female", new DateTime(2019, 9, 11));
